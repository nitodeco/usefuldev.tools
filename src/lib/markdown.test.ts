...
import { htmlToMarkdown, markdownToHtml, sanitizeHtml } from './markdown';
...
describe('markdown utilities', () => {
  ...
  describe('htmlToMarkdown', () => {
    it('should convert HTML to markdown', () => {
      const html =
        '<h1>Hello World</h1><p>This is a <strong>bold</strong> text with a <a href="https://example.com">link</a></p>';
